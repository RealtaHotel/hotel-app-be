...
__decorate([
    (0, typeorm_1.Column)("integer", { name: "border_boor_id", nullable: true, unique: true }),
    __metadata("design:type", Number)
], BookingOrderDetail.prototype, "borderBoorId", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToOne)(() => BookingOrders_1.BookingOrders, (bookingOrders) => bookingOrders.bookingOrderDetail, { onDelete: "CASCADE", onUpdate: "CASCADE" }),
...
BookingOrderDetail = __decorate([
    ...
    (0, typeorm_1.Index)("booking_order_detail_border_boor_id_key", ["borderBoorId"], {
        unique: true,
    }),
