...
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)({ type: "integer", name: "poca_id" }),
    __metadata("design:type", Number)
], PolicyCategoryGroup.prototype, "pocaId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => CategoryGroup_1.CategoryGroup, (categoryGroup) => categoryGroup.policyCategoryGroups, { onDelete: "CASCADE", onUpdate: "CASCADE" }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Policy_1.Policy, (policy) => policy.policyCategoryGroups, {
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
    }),
...
PolicyCategoryGroup = __decorate([
    (0, typeorm_1.Index)("poca_poli_id_pk", ["pocaId"], { unique: true }),
