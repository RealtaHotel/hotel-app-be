...
__decorate([
    (0, typeorm_1.Column)("integer", { name: "ephi_emp_id", nullable: true }),
    __metadata("design:type", Number)
], EmployeePayHistory.prototype, "ephiEmpId", void 0);
__decorate([
...
EmployeePayHistory = __decorate([
    (0, typeorm_1.Index)("pk_ephi_id", ["ephiRateChangeDate"], { unique: true }),
    (0, typeorm_1.Entity)("employee_pay_history", { schema: "hr" })
], EmployeePayHistory);
