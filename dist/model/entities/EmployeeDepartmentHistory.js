...
__decorate([
    (0, typeorm_1.Column)("integer", { name: "edhi_emp_id", nullable: true, unique: true }),
    __metadata("design:type", Number)
...
__decorate([
    (0, typeorm_1.OneToOne)(() => Employee_1.Employee, (employee) => employee.employeeDepartmentHistory, {
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
    }),
