...
__decorate([
    (0, typeorm_1.Column)('integer', { name: 'edhi_emp_id', nullable: true, unique: false }),
    __metadata("design:type", Number)
], EmployeeDepartmentHistory.prototype, "edhiEmpId", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Department_1.Department, (department) => department.employeeDepartmentHistory, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
    }),
...
EmployeeDepartmentHistory = __decorate([
    (0, typeorm_1.Index)('employee_department_history_edhi_emp_id_key', ['edhiEmpId'], {
        unique: false,
    }),
    (0, typeorm_1.Index)('pk_edhi_id', ['edhiId'], { unique: true }),
    (0, typeorm_1.Entity)('employee_department_history', { schema: 'hr' })
