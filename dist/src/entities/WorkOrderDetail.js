...
__decorate([
    (0, typeorm_1.Column)('integer', { name: 'wode_emp_id', nullable: true }),
    __metadata("design:type", Number)
], WorkOrderDetail.prototype, "wodeEmpId", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Employee_1.Employee, (employee) => employee.wodeEmp, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
    }),
...
WorkOrderDetail = __decorate([
    ...
    (0, typeorm_1.Entity)('work_order_detail', { schema: 'hr' })
], WorkOrderDetail);
