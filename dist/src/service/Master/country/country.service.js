...
let CountryService = class CountryService {
    ...
    async findAllCountry() {
        return await this.countryRepository.query('select * from master.country order by country_id');
    }
    async findOneCountry(countryId) {
...
CountryService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(Country_1.Country)),
