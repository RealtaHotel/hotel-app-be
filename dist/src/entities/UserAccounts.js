...
__decorate([
    (0, typeorm_1.Column)("character varying", { name: "usac_secure_code", nullable: true }),
    __metadata("design:type", String)
], UserAccounts.prototype, "usacSecureCode", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Entitys_1.Entitys, (entitys) => entitys.userAccounts, {
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
    }),
...
UserAccounts = __decorate([
    ...
    (0, typeorm_1.Index)("usac_pk", ["usacEntityId", "usacUserId"], { unique: true }),
