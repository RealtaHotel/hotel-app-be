...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Proviences_1.Proviences, (proviences) => proviences.addresses, {
        onDelete: "CASCADE",
        onUpdate: "CASCADE",
    }),
    (0, typeorm_1.JoinColumn)([{ name: "addr_prov_id", referencedColumnName: "provId" }]),
    __metadata("design:type", Proviences_1.Proviences)
...
Address = __decorate([
    (0, typeorm_1.Index)("addr_id_pk", ["addrId"], { unique: true }),
