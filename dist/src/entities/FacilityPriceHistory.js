...
__decorate([
    (0, typeorm_1.Column)('money', { name: 'faph_rate_price', nullable: true }),
    __metadata("design:type", String)
], FacilityPriceHistory.prototype, "faphRatePrice", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Facilities_1.Facilities, (facilities) => facilities.facilityPriceHistories, { onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
...
FacilityPriceHistory = __decorate([
    (0, typeorm_1.Index)('pk_facility_price_history', ['faphId'], { unique: true }),
