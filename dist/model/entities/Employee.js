...
__decorate([
    (0, typeorm_1.Column)("date", { name: "emp_birth_date", nullable: true }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)("smallint", { name: "emp_sickleave_hourse", nullable: true }),
    __metadata("design:type", Number)
], Employee.prototype, "empSickleaveHourse", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToOne)(() => EmployeeDepartmentHistory_1.EmployeeDepartmentHistory, (employeeDepartmentHistory) => employeeDepartmentHistory.edhiEmp),
    __metadata("design:type", EmployeeDepartmentHistory_1.EmployeeDepartmentHistory)
], Employee.prototype, "employeeDepartmentHistory", void 0);
__decorate([
...
Employee = Employee_1 = __decorate([
    ...
    (0, typeorm_1.Entity)("employee", { schema: "hr" })
], Employee);
