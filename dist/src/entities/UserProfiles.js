...
__decorate([
    (0, typeorm_1.Column)("date", { name: "uspro_birt_date", nullable: true }),
    __metadata("design:type", String)
], UserProfiles.prototype, "usproBirtDate", void 0);
__decorate([
    (0, typeorm_1.Column)("character varying", {
...
__decorate([
    ...
    __metadata("design:type", String)
], UserProfiles.prototype, "usproMartialStatus", void 0);
__decorate([
...
UserProfiles = __decorate([
    (0, typeorm_1.Index)("usme_user_pk", ["usproId"], { unique: true }),
