...
const FacilityPhoto_1 = require("./FacilityPhoto");
...
__decorate([
    ...
    __metadata("design:type", Date)
], Facilities.prototype, "faciEnddate", void 0);
__decorate([
    (0, typeorm_1.Column)('money', { name: 'faci_low_price', nullable: true }),
    __metadata("design:type", String)
], Facilities.prototype, "faciLowPrice", void 0);
__decorate([
    (0, typeorm_1.Column)('money', { name: 'faci_high_price', nullable: true }),
    __metadata("design:type", String)
], Facilities.prototype, "faciHighPrice", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => FacilityPhoto_1.FacilityPhoto, (facilityPhoto) => facilityPhoto.faphoFaci),
    __metadata("design:type", Array)
...
Facilities = __decorate([
    (0, typeorm_1.Index)('pk_faci_id', ['faciId'], { unique: true }),
